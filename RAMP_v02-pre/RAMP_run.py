...
af_calculation = False # To choose if availability factors calculation is needed
...
#        pp.export_pickle('Profiles_User', Profiles_user_temp, inputfile, simulation_name)
    ...
    if charging:
        ...
        # Ch_profile_user, Charging_profile, SOC_user, plug_in_user, en_sys_tot = Charging_Process(Profiles_user_temp, User_list, country, year, dummy_days, inputfile_load, inputfile_pv, inputfile_wind, inputfile_cap , charging_mode = 'Uncontrolled', logistic = False, infr_prob = 1, Ch_stations = ([3.7, 11, 120], [0.6, 0.3, 0.1]))        
        ...
        Ch_profile_user, Charging_profile, SOC_user, plug_in_user, en_sys_tot = Charging_Process(Profiles_user_temp, User_list, country, year, dummy_days, inputfile_load, inputfile_pv, inputfile_wind, inputfile_cap, charging_mode = 'Uncontrolled', logistic = False, infr_prob = 'piecewise', 
